...
points(1:15, -s_fit*tc + fits, col = "orange", type = "l", lwd = 2)
```
<p>Jak widać, prosta przybliżająca nasze wartości znajduje się pomiędzy pasmami ufności, choć wiele obserwacji jest poza nimi.</p>
...
#zad 7
#wygenerować wektor 200 wymiarowy, przekształcić afinicznie, przetestować hipotezę H_0: b_1 = 0 i powtórzyć to 1000 razy, generując wektor 1000 elementowy z zerami i jedynkami, gdzie 1 oznacza obalenie hipotezy zerowej. Obliczyć frakcję jedynek i ta frakcja oznacza:
#a) prawdopodobieństwo błedu pierwszego rodzaju
#c) moc testu
#Potem porównać z teoretycznymi obliczeniami.
