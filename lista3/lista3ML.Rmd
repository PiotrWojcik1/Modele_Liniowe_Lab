...
<h2>Zadanie 10</h2>
<p>W poniższym zadaniu skorzystamy z tego co wyznaczyliśmy w poprzednim. Wygenerujemy zmienną $\small Z = \log{Y}$, gdzie $\small Y$ jest zmienną objaśniającą z poprzednich zadań. Następnie skonstruujemy model dla tej zmiennej.</p>
...
lines(seq(-2,13,by=5), ZX_model$coefficients[1] + ZX_model$coefficients[2]*seq(-2,13,by=5), tyle = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,2], type = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,3], type = "l", lwd = 2)
```
...
plot(solution$time, solution$concentration, xlab = "czas", ylab = "stężenie", xlim = c(0,10))
lines(seq(-2,13,by=0.1), exp(ZX_model$coefficients[1] + ZX_model$coefficients[2]*seq(-2,13,by=0.1)), tyle = "l", lwd = 2, col = "green")
lines(seq(-2, 12, by = 0.5), exp(predictions[,2]), type = "l", lwd = 2, col = "Blue")
lines(seq(-2, 12, by = 0.5), exp(predictions[,3]), type = "l", lwd = 2, col = "Red")
```
...
lines(seq(-2,13,by=5), YX1_model$coefficients[1] + YX1_model$coefficients[2]*seq(-2,13,by=5), tyle = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,2], type = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,3], type = "l", lwd = 2)
```
...
lines(seq(-2,13,by=5), ZX1_model$coefficients[1] + ZX1_model$coefficients[2]*seq(-2,13,by=5), tyle = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,2], type = "l", lwd = 2)
lines(seq(-2, 12, by = 0.5), predictions[,3], type = "l", lwd = 2)
```
<p>Porównując oba wykresy, to najużyteczniejszy wydaje się tylko pierwszy model, gdzie widać, że relacja jaką uzyskaliśmy jest rzeczywiście liniowa. Drugi wykres natomiast wyraźnie odbiega od relacji liniowej.</p>
